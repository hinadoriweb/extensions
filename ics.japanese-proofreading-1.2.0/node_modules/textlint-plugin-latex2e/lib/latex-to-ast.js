...
const parse = (text) => {
    ...
    return (0, pipeable_1.pipe)({
        ...
        raw: text,
        range: (0, function_1.tuple)(0, text.length),
        loc: {
            start: (0, calculatePosition_1.default)(text, 0),
            end: (0, calculatePosition_1.default)(text, text.length - 1),
        },
        children: latexAst.content
            .map(transform(text))
            .reduce((a, b) => [...a, ...b], []),
    }, paragraphize_1.default, (0, completeComment_1.completeComments)(comments)(text), (0, completeBlank_1.default)(text));
};
exports.parse = parse;
